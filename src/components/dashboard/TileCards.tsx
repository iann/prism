...
function TileShell({ href, icon, title, children, accent }: {
  ...
  const inner = (
    <div className="h-full bg-card hover:border-primary dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm dark:hover:border-primary/30 rounded-xl border border-border p-3 flex flex-col gap-2 transition-colors overflow-hidden">
