...
export function FilterBar({ children, className }: FilterBarProps) {
  ...
  if (isMobile) {
    return (
      <div className={cn('wall-filter-bar shrink-0 border-b border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm', className)}>
        <button
  ...
  return (
    <div className={cn('wall-filter-bar shrink-0 border-b border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm px-3 py-1.5 max-h-24 overflow-y-auto', className)}>
