...
function CoordInput({
  ...
  return (
    <input
      ...
      onFocus={onFocus}
      onBlur={onBlur}
      className="w-full rounded border border-border bg-muted px-1 py-0.5 text-center text-xs text-foreground transition-colors focus:outline-hidden focus:ring-1 focus:ring-primary"
    />
  );
}
