  ...
  const getGreeting = (date: Date) => {
    ...
    const greetings = {
      morning: [
        ...
        'Morning sunshine', 'Early bird!', 'Moin moin', 'Servus',
        ...
        'Land ho!', 'Clear skies ahead', 'Egg-cellent morning',
        ...
        'Engage!', 'Make it so', 'To infinity and beyond',
        ...
        'Dancing in the light', 'Nants ingonyama',
        ...
        'Gratitude start', 'Infinite possibilities',
        ...
        'The Iliad Morning', 'The Aeneid Morning', 'Frankenstein\'s Morning', 'Alice in Wonderland Morning',
        ...
        // More languages
        'Ohayō', 'Dobro jutro', 'Suprabhat', 'Sabah el nour', 'Kalimera', 'Shubh prabhat',
        // Food & start-of-day
        'Breakfast club', 'Rise and dine', 'OJ o\'clock', 'Sunny side up', 'Pancakes?',
        'Waffles await', 'Cereal time',
        // Playful & whimsical
        'Look who\'s up!', 'The legend awakens', 'About time!', 'There you are!',
        'Morning, champ', 'Morning, slugger', 'Rise, champion', 'Oh hey!',
        'Good morning to you', 'And they\'re off!',
        // Nature sounds
        'Birdsong', 'First robin', 'Dewy fields',
        // Pop culture & gaming
        'Good morning, Vietnam!', 'It\'s alive!', 'System online', 'Player 1 ready',
        'Quest accepted', 'Adventure awaits', 'Press start', 'New game+',
        // Motivation
        'Own it', 'Show up', 'Level up', 'Make it count', 'Your day',
        'Zero to hero', 'Hero time', 'Suit up', 'Step up',
      ],
      afternoon: [
        ...
        'Grateful', 'Prosperous', 'Abundant', 'Limitless', 'Fearless', 'Bold',
        ...
        'Sunshine of my life', 'Pocketful of sunshine',
        'Walking on a dream', 'Higher ground', 'I feel good',
        ...
        'Zenith mood', 'Meridian flow', 'Solar peak', 'High noon focus', 'Meridian energy',
        'Meridian vision', 'Meridian clarity', 'Meridian purpose',
        // Family
        'School\'s out?', 'How was school?', 'Snack attack', 'Homework time?', 'After-school vibes',
        // Food
        'Snack time?', 'Cookie o\'clock', 'Tea time', 'Coffee #2?', 'Afternoon fuel',
        // Casual
        'Hang in there', 'Getting there', 'Is it Friday yet?', 'Second wind',
        'Back at it', 'Round two', 'Pit stop', 'Top off the tank',
        // Outdoorsy
        'Sun\'s still up', 'Step outside', 'Walk time?', 'Stretch break',
        // Fun
        'Plot twist', 'Halftime', 'Intermission', 'Commercial break',
      ],
      evening: [
        'Good evening', 'Evening', '¡Buenas noches!', 'Noches', 'Bonsoir',
        'Salut', 'Guten Abend', 'Abend', 'Buonasera', 'Ciao',
        'Boa noite', 'Goedenavond', 'God kväll', 'Yo', 'Hey', 'Stay gold', 'Peace out',
        'Dobry wieczór', 'İyi akşamlar', 'Magandang gabi', 'Selamat malam', 'Bună seara',
        'Hyvää iltaa', 'God kveld', 'Ahoj', 'Salve', 'Evening vibes',
        'Rest well', 'Sunset mood', 'Chill time', 'What\'s up?',
        'How was your day?', 'Nice evening', 'Hey you', 'Catch you later',
        'See ya', 'Until tomorrow', 'Stay cool',
        ...
        'Crickets chirping', 'Owl\'s hoot', 'Night\'s melody',
        'Magic in the dark', 'Hidden wonders', 'Secrets of the night', 'Whisper of the wind',
        'Rustle of leaves', 'Soft finish', 'Wrap up the day', 'Mission accomplished', 'Proud of you',
        'Home sweet home', 'Evening grace',
        'Evening glow', 'Dusk settled', 'Reflection time',
        'Gratitude', 'Peace of mind', 'Calm heart',
        'Anchored', 'Port side', 'Starboard night',
        'Softening', 'Release', 'Letting go', 'Transition', 'Threshold',
        'How deep is your love', 'Smooth operator', 'Stayin\' alive',
        'Electric feel', 'Pursuit of happiness', 'After hours', 'Digital dusk',
        'Evening zen', 'Stardust evening',
        // Family & home
        'Dinner time!', 'Welcome home!', 'Family time!', 'Table\'s set', 'Dinner\'s on',
        'Pull up a chair', 'Come on in',
        // End of day
        'Made it', 'Done and dusted', 'Earned it', 'Day well spent', 'Clock out',
        'Off the clock', 'Work\'s done', 'Survived another one', 'Clocked out',
        // Entertainment
        'Movie time?', 'Game night?', 'What\'s on tonight?', 'Board game time?',
        'Pick a movie', 'Channel surfing',
        // Outdoorsy/ambient
        'Fireflies', 'Porch vibes', 'Fire pit time', 'Backyard vibes',
        // More languages
        'Dobar veče', 'Dobryy vecher', 'Bonsoir tout le monde', 'Seara buna',
      ],
      bedtime: [
        'Nighty night', 'Sleep tight', 'Sweet dreams', 'Good night', 'Sleep well',
        'Night night', 'Dream big', 'Rest up', 'Gn', 'Night', 'Peace', 'Later',
        'Laters', 'Cya', 'Catch ya', 'Late night?', 'Sleepy head?', 'Moonlight', 'Starry night',
        'Dream sweet', 'Sleep soundly', 'Rest easy', 'Goodnight moon',
        'Off to bed', 'Bedtime', 'Slumber time', 'Counting sheep', 'Lights out',
        'See you in the morning', 'Night owl', 'Midnight oil', 'Late hours',
        'Quiet night', 'Darkness falls', 'Starlight', 'Night sky',
        'Cool night', 'Warm night', 'Sleepy time', 'Tired eyes', 'Deep sleep',
        'Restorative', 'Recharge', 'Renew',
        ...
        'Stardust', 'Orion\'s belt', 'Milky Way', 'Star gazing', 'Don\'t let the bedbugs bite', 'Time for bed',
        'Soft pillow', 'Warm blankets', 'Nesting', 'Hibernate', 'Night bloom', 'Lunar light',
        'Tides turning', 'Pure dreams', 'Mystic night',
        'Enchanted evening', 'Symphony of silence', 'Deep blue', 'Indigo sky', 'Purple haze',
        'Midnight velvet', 'Silk and stars', 'Celestial dance', 'Infinite space', 'Beyond the stars',
        'To the edge of the world', 'Quiet strength', 'Well deserved rest', 'See you at dawn',
        'Till the sun rises', 'Light tomorrow with today', 'Sleep in peace', 'Until morning',
        ...
        'Goodnight world', 'Evening star',
        'Fly me to the moon', 'Starry starry night', 'Night moves',
        ...
        'Starman', 'The passenger', 'After dark', 'Night fever', 'Night birds', 'Nightcall',
        'Midnight city', 'Day \'n\' nite',
        'Lights out', 'System shutdown', 'Defragmenting', 'Backup complete',
        'Cloud sync finished', 'Dark mode enabled', 'Sleep mode', 'Standby',
        ...
        'Serenity', 'Reflection point', 'Graceful exit', 'Mindful rest', 'Grateful heart',
        'Liminal space', 'Dream portal', 'Star gate', 'Celestial bridge',
        'Infinite peace', 'Beginning of night',
        'End of effort', 'Pure silence',
        ...
        'Reliable rest', 'Consistent calm', 'Trusting sleep',
        ...
        'Starry starry night (Vincent)', 'Night and day', 'To the moon and back',
        'Midnight train', 'Night shift', 'Under the moonlight', 'Galaxy\'s sleep', 'Cosmic rest',
        'Interstellar night', 'Stardust slumber', 'Quantum night',
        'Safe harbor night', 'Celestial navigation night', 'North star guidance',
        'Polaris light', 'Sirius glow', 'Peaceful sleep',
        'Restorative night', 'Recharging', 'Renewing', 'Dream portal open',
        // Multilingual good nights
        'Bonne nuit', 'Buenas noches', 'Oyasuminasai', 'Jó éjszakát', 'Leil tov',
        'Gece iyi', 'Dobrú noc', 'Laku noć', 'Dobru noć',
        // Cozy & lullaby
        'Close your eyes', 'Head hits the pillow', 'Drifting off...', 'All is quiet',
        'Moon is high', 'Stars are out', 'Hush now', 'Night has settled',
        'Duvet time', 'Under the covers', 'Blanket fort', 'Pillow time',
        'Rock-a-bye', 'Hush little one', 'Lullaby time',
        // Gaming / tech shutdown
        'Save progress?', 'Game saved', 'Respawn tomorrow', 'Checkpoint reached',
        'Level complete', 'Player offline', 'AFK', 'Away mode', 'Logging off',
        // Night sky extras
        'Shooting stars', 'Full moon tonight', 'Waning crescent', 'Aurora dreams',
        'Jupiter\'s up', 'Meteor shower',
      ],
    };
    ...
    else if (hour >= 19) bucket = 'bedtime';
