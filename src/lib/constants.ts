...
/** Settings key controlling how source-calendar deletions are handled. */
export const AUTO_DELETE_REMOVED_CALENDAR_EVENTS_SETTING_KEY = 'calendar.autoDeleteRemovedEvents';
