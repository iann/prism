...
describe('useCalendarWidgetPrefs', () => {
  ...
  it('isolates view preferences by calendar instance', () => {
    const first = renderHook(() => useCalendarWidgetPrefs(48, 48, 'calendar'), { wrapper: TimeFormatProvider });
    const second = renderHook(() => useCalendarWidgetPrefs(48, 48, 'calendar-2'), { wrapper: TimeFormatProvider });
  ...
  it('retains the legacy key for the original calendar instance', () => {
    ...
    const hook = renderHook(() => useCalendarWidgetPrefs(48, 48, 'calendar'), { wrapper: TimeFormatProvider });
  ...
  it('uses the legacy namespace when no instance ID is supplied', () => {
    ...
    const hook = renderHook(() => useCalendarWidgetPrefs(48, 48), { wrapper: TimeFormatProvider });
