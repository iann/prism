...
export function TaskItem({
  ...
  return (
    <div
      className={cn(
        'group flex items-center gap-4 p-4 rounded-lg border border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm',
    ...
    >
      ...
      <div className="flex items-center gap-1 opacity-50 group-hover:opacity-100 transition-opacity">
        <Button
          ...
          size="icon"
          onClick={onEdit}
          className="wall-touch-control h-8 w-8 text-muted-foreground hover:text-foreground"
        ...
        <Button
          ...
          size="icon"
          onClick={onDelete}
          className="wall-touch-control h-8 w-8 text-muted-foreground hover:text-destructive"
