          ...
          {loading ? (
            ...
            <div className="grid gap-3 max-w-6xl mx-auto" style={{
              ...
              {messagesByAuthor.map(({ member, messages: msgs }) => (
                <div
                  key={member.id}
                  className="flex flex-col border-2 rounded-lg overflow-hidden bg-card dark:bg-card/90 backdrop-blur-xs dark:backdrop-blur-sm"
...
function MessageCard({
  ...
  return (
    <div
      className={cn(
        'p-4 rounded-lg border border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm',
