  ...
  return (
    <PageWrapper>
      <div className="h-screen flex flex-col">
        {!shoppingMode && (
          <>
            ...
            {isMobile && lists.length > 1 ? (
              <div className="shrink-0 border-b border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm px-2 py-1">
              ...
              <div className="shrink-0 border-b border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm px-3 py-1">
        ...
        {shoppingMode && (
          <header className="shrink-0 border-b border-border bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm px-3 py-1 safe-area-top">
        ...
        {activeList && totalItems > 0 && !shoppingMode && (
          <div className="shrink-0 px-3 py-1 bg-card dark:bg-card/85 backdrop-blur-xs dark:backdrop-blur-sm">
              ...
              {otherItems.length > 0 && (
                <div className="mt-6 space-y-4">
                  ...
                  {otherItems.map(([category, items]) => (
                    <div key={category} className="border rounded-lg p-3 bg-card dark:bg-card/90 backdrop-blur-xs dark:backdrop-blur-sm">
