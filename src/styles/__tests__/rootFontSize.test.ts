...
describe('root font-size ladder', () => {
  ...
  // A mouse means someone is at a desk, close up. The personal wall-display
  // rhythm keeps this branch at 16px, and the upstream kiosk change leaves it
  // alone.
